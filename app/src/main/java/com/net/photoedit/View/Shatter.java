package com.net.photoedit.View;
                    ...
                    for (j = 0; j < county; j++) {
                        if (drawBlock[i][j]) {
                            ...
                            try {
                                ...
                                Bitmap bm = ImageViewPhoto.Clone(img, (int) (((float) i) * w), (int) (((float) j) * w), cubesize, cubesize);
                                if (bm != null) {
        ...
        public Bitmap Apply(Bitmap img) {
            ...
            try {
                ...
                if (this.boolPar[0].value) {
                    ...
                    Bitmap croppedImg = ImageViewPhoto.Clone(img, (width - s) / 2, (height - s) / 2, s, s);
                ...
                bm = ImageViewPhoto.NewImage(dstImg, this.colorPar[0].getValue(), false);
    ...
    public class MapImage extends Filter {
        ...
        private Bitmap GetImg(Bitmap img, int w, int h) {
            ...
            try {
                ...
                dstImg = ImageViewPhoto.Clone(img, x, y, w, h);
            } catch (Exception e) {
                e.printStackTrace();
            }
            if (dstImg == null) {
